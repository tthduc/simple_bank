...
// Source: example.com/m/internal/db (interfaces: Store)
...
// GetAccountFroUpdate mocks base method.
func (m *MockStore) GetAccountFroUpdate(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountFroUpdate", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountFroUpdate indicates an expected call of GetAccountFroUpdate.
func (mr *MockStoreMockRecorder) GetAccountFroUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountFroUpdate", reflect.TypeOf((*MockStore)(nil).GetAccountFroUpdate), arg0, arg1)
}
