...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getAccountFroUpdateStmt, err = db.PrepareContext(ctx, getAccountFroUpdate); err != nil {
		return nil, fmt.Errorf("error preparing query GetAccountFroUpdate: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getAccountFroUpdateStmt != nil {
		if cerr := q.getAccountFroUpdateStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getAccountFroUpdateStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getAccountFroUpdateStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getAccountFroUpdateStmt: q.getAccountFroUpdateStmt,
